...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'aktata@outlook.com',
  ...
  protectedRoutes: ['/Private folder', '/Cloud'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:a@aktata.com',
